...
print(max(percent), min(percent),sum(percent))

for element in range(0,len(percent)-1):
    print(percent[element])
    print(int(percent[element]))
    print(round(percent[element],2))
    print(sumOfPoints*int(percent[element])/100)
