...
##    # factor to współczynnik ciągu geometrycznego
##    # index - wskazuje który element ciągu ma być wyliczony
##
##    # funkcja obliczająca elementy ciągu geometrycznego
##    ciag_geom = []
##    ciag_geom.append(a1)
##    maxindex = 70
...
##        a1 = a2
##        
##    return ciag_geom[index-1]
##
##print(GiveGeomSeqElement(a1 =1, index = 64))
